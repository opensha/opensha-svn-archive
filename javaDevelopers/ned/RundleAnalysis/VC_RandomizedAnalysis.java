package javaDevelopers.ned.RundleAnalysis;
  ...
  */
  ...
  public VC_RandomizedAnalysis() {
    ...
    Read_VC_FaultActivity read_vc_faultactivity_saf = new
        Read_VC_FaultActivity("javaDevelopers/ned/RundleAnalysis/RundleVC_data/VC_Fault_Activity_SAF.txt");
...
*/
  ...
  private void writeSegmentStats() throws IOException {
    FileWriter fw = new FileWriter("javaDevelopers/ned/RundleAnalysis/RundleVC_data/VC_segRandRecurIntervals.txt");
...
//    for(int j=0;j<1;j++) { // loop over segments
  ...
  private void writeSegNumYearSlip() throws IOException {
    FileWriter fw = new FileWriter("javaDevelopers/ned/RundleAnalysis/RundleVC_data/VC_segRandNumYearSlip.txt");
    SegmentSlipTimeInfo segInfo;
...
//        }
  ...
  private void writeEventData() throws IOException  {
    String filename1 = "javaDevelopers/ned/RundleAnalysis/RundleVC_data/VC_RandEventTimesNumSegs.txt";
    String filename2 = "javaDevelopers/ned/RundleAnalysis/RundleVC_data/VC_RandEventSegs.txt";
    String evName;
    ArrayList tempSegs;
    Double year;
    double lastYear=-1.;
  ...
  private void writeFaultTraces() throws IOException {
    ...
    FileWriter fw = new FileWriter("javaDevelopers/ned/RundleAnalysis/RundleVC_data/VC_faultTraces.txt");
    FaultTrace trace;
    Location tempLoc;
    for(int i=0; i< faultList.size();i++) {
    ...
    fw = new FileWriter("javaDevelopers/ned/RundleAnalysis/RundleVC_data/VC_faultNamesNumPts.txt");
    for(int i=0; i< faultList.size();i++) {
      trace = (FaultTrace) faultList.get(i);
      fw.write(trace.getName()+"\t"+trace.getNumLocations()+"\n");
    }
