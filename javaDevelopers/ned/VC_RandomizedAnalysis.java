...
//    for(int j=0;j<1;j++) { // loop over segments
  ...
  private void writeSegNumYearSlip() throws IOException {
    FileWriter fw = new FileWriter("javaDevelopers/ned/RundleVC_data/VC_segRandNumYearSlip.txt");
    SegmentSlipTimeInfo segInfo;
...
//        }
  ...
  private void writeEventData() throws IOException  {
    String filename1 = "javaDevelopers/ned/RundleVC_data/VC_RandEventTimesNumSegs.txt";
    String filename2 = "javaDevelopers/ned/RundleVC_data/VC_RandEventSegs.txt";
    String evName;
    ArrayList tempSegs;
    Double year;
    double lastYear=-1.;
