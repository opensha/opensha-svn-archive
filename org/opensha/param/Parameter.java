        ...
        ParameterAPI, java.io.Serializable
{
    ...
    /**
     ...
     public void unableToSetValue( Object value ) throws ConstraintException {
       ...
       org.opensha.param.event.ParameterChangeFailEvent event =
           new org.opensha.param.event.ParameterChangeFailEvent(this,
     ...
     */
    public synchronized void addParameterChangeFailListener( org.opensha.param.event.ParameterChangeFailListener listener ) {
     ...
     */
    public synchronized void removeParameterChangeFailListener( org.opensha.param.event.ParameterChangeFailListener listener ) {
     ...
     */
    public void firePropertyChangeFailed( org.opensha.param.event.ParameterChangeFailEvent event ) {
        ...
        for ( int i = 0; i < vector.size(); i++ ) {
            org.opensha.param.event.ParameterChangeFailListener listener = ( org.opensha.param.event.ParameterChangeFailListener ) vector.get( i );
    ...
    public synchronized void addParameterChangeListener( org.opensha.param.event.ParameterChangeListener listener ) {
     ...
     * @param  listener  Description of the Parameter
     */
    public synchronized void removeParameterChangeListener( org.opensha.param.event.ParameterChangeListener listener ) {
...
*/
    public void firePropertyChange( ParameterChangeEvent event ) {
        ...
        for ( int i = 0; i < vector.size(); i++ ) {
            org.opensha.param.event.ParameterChangeListener listener = ( org.opensha.param.event.ParameterChangeListener ) vector.get( i );
