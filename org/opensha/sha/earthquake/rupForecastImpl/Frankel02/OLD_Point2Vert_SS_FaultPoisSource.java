...
public class OLD_Point2Vert_SS_FaultPoisSource extends ProbEqkSource implements java.io.Serializable{
 ...
 /**
   ...
   */
  public OLD_Point2Vert_SS_FaultPoisSource(Location loc, IncrementalMagFreqDist magFreqDist,
...
//                                       wc_rel,45, 1.0, 6.0, 5.0);
    OLD_Point2Vert_SS_FaultPoisSource src = new OLD_Point2Vert_SS_FaultPoisSource(loc, dist,
                                       wc_rel, 1.0, 6.0, 5.0);
