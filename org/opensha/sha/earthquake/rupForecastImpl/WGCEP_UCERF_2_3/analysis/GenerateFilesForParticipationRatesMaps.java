 ...
 *
 */
public class GenerateFilesForParticipationRatesMaps {
	
	public static void main(String[] args) {
		int duration = 30;
		double mags[] = { 5.0, 6.0, 6.5, 6.7, 7.5, 8.0};
	    ...
	    for (int sourceIndex = 0; sourceIndex < numSources; ++sourceIndex) {
	      ...
	      for (int rupIndex = 0; rupIndex < numRuptures; ++rupIndex) {
	        ...
	        while (it.hasNext()) {
	          ...
	          if(locIndex==prevLocIndex || locIndex<0) continue;
