 ...
 *
 */
// FORNOW THIS IS INCLUDED IN THIS CLASS BUT IT WILL BE EXTERNALIZED AS SOON AS
// WE HAVE A LIBRARY SET UP
interface Blender {
	public Color blend(Color small, Color big, float bias);
}

class LinearBlender implements Blender {
	/**
...
//		the range of the CPT file and similarly for the max
	...
	public String toString() {
		String out= "# CPT File generated by CPT.java";
		for(CPTVal v: this){
			out = out + v.toString();
		}
