...
public class GMT_WebServiceAPI_runGMT_Script_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        org.opensha.webservices.client.GMT_WebServiceAPI_runGMT_Script_ResponseStruct instance = new org.opensha.webservices.client.GMT_WebServiceAPI_runGMT_Script_ResponseStruct();
        org.opensha.webservices.client.GMT_WebServiceAPI_runGMT_Script_ResponseStruct_SOAPBuilder builder = null;
        Object member;
        ...
        if (reader.getState() == XMLReader.START) {
            ...
            if (member instanceof SOAPDeserializationState) {
                if (builder == null) {
                    builder = new org.opensha.webservices.client.GMT_WebServiceAPI_runGMT_Script_ResponseStruct_SOAPBuilder();
                }
    ...
    public void doSerializeInstance(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        org.opensha.webservices.client.GMT_WebServiceAPI_runGMT_Script_ResponseStruct instance = (org.opensha.webservices.client.GMT_WebServiceAPI_runGMT_Script_ResponseStruct)obj;
