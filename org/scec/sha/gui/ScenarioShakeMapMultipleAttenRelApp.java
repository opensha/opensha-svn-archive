...
/**
 * <p>Title: ScenarioShakeMapMultipleAttenRelApp</p>
 * <p>Description: This application supports the multiple AttenuationRelationships
 * in the gui beans. Thats the only difference it has currently with the
 * ScenarioshakeMapApp, which only allows the selection of the single AttenuationRelatinship
 * per calculation.</p>
...
public class ScenarioShakeMapMultipleAttenRelApp extends JApplet implements ParameterChangeListener,
  ...
  public ScenarioShakeMapMultipleAttenRelApp() {
  }
  ...
  public static void main(String[] args) {
    ScenarioShakeMapMultipleAttenRelApp applet = new ScenarioShakeMapMultipleAttenRelApp();
