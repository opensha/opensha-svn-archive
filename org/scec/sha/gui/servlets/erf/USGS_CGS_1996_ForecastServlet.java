...
public class USGS_CGS_1996_ForecastServlet extends HttpServlet implements ERF_WebServiceAPI{
  ...
  //object for the Frankel96 Ekq Forecast
  Frankel96_AdjustableEqkRupForecast frankelForecast = new Frankel96_AdjustableEqkRupForecast();
  ...
  public String getName(){
    return this.frankelForecast.getName();
  }
  ...
  public ParameterList getAdjustableParams(){
    return frankelForecast.getAdjustableParameterList();
  }
 ...
 public ERF_API getERF_API(TimeSpan time, ParameterList params){
   Frankel96_AdjustableEqkRupForecast frankelERF = new Frankel96_AdjustableEqkRupForecast();

   //getting the parameterList for the Frankel-96 forecast
   ParameterList paramList = frankelERF.getAdjustableParameterList();
   ...
   frankelERF.setParameterChangeFlag(true);
   frankelERF.updateForecast();
   return (ERF_API)frankelERF;
 }
 ...
 public TimeSpan getTimeSpan() {
   return frankelForecast.getTimeSpan();
 }
