 ...
 * <p>Description: This is the Servlet mode implementation of the STEP Forecast model</p>
...
public class STEP_EqkRupForecastServlet extends HttpServlet implements ERF_WebServiceAPI{
  ...
  private void STEP_EqkRupForecast() {
    ...
    try{
      inputFileLines = FileUtils.loadFile(new URL(this.INPUT_FILE_NAME));
    }catch(Exception e){
      e.printStackTrace();
    }
  }
  ...
  public ERF_API getERF_API(TimeSpan time, ParameterList param){
    STEP_EqkRupForecastObject stepERF =
        new STEP_EqkRupForecastObject(time,this.inputFileLines);
