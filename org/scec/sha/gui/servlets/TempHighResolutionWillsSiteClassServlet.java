...
/**
 * <p>Title: TempHighResolutionWillsSiteClassServlet  </p>
...
public class TempHighResolutionWillsSiteClassServlet  extends HttpServlet {


  //File from which we get the Vs30
  private final String VS_30_INPUT_FILENAME = "/opt/install/jakarta-tomcat-4.1.24/webapps/OpenSHA/WEB-INF/dataFiles/vsgrid60s_translated.txt";
  ...
  private void getVs30(Vector locationVector,ObjectOutputStream output) {
    ...
    double gridSpacingForVs30InFile = .018 +.001;
    try {
