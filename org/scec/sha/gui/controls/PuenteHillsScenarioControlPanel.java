...
public class PuenteHillsScenarioControlPanel {
  ...
  public void setParamsForPuenteHillsScenario(){
    ...
    imrGuiBean.getSelectedIMR_Instance().getParameter(ShakeMap_2003_AttenRel.COMPONENT_NAME).setValue(ShakeMap_2003_AttenRel.COMPONENT_MAX_HORZ);
    ...
    regionGuiBean.getParameterList().getParameter(regionGuiBean.SITE_PARAM_NAME).setValue(regionGuiBean.SET_SITE_USING_HIGH_RESOLUTION_WILLS_CLASS_TYPE);
