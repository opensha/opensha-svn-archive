...
public class DahleEtAl_1995_AttenRel
    ...
    protected void updateCoefficients() throws ParameterException {
        ...
        if( coefficients.containsKey( key.toString() ) ) coeff = ( DahleEtAl_AttenRelCoefficients )coefficients.get( key.toString() );
    ...
    public double getMean() throws IMRException{
        ...
        int S;
        if(siteTypeValue.equals(SITE_TYPE_ROCK))    S = 0;
        else                                        S = 1;
    ...
    protected void initSupportedIntensityMeasureParams( ) {
        ...
        while ( keys.hasMoreElements() ) {
            DahleEtAl_AttenRelCoefficients coeff = ( DahleEtAl_AttenRelCoefficients ) coefficients.get( keys.nextElement() );
    ...
    protected void initCoefficients(  ) {
        ...
        // PGA
        DahleEtAl_AttenRelCoefficients coeff = new DahleEtAl_AttenRelCoefficients(PGA_NAME,
            0,-1.579,0.554,-0.560,-0.00302,0.326,6.0,0.75,0.73);

        // SA/0.00
        DahleEtAl_AttenRelCoefficients coeff0 = new DahleEtAl_AttenRelCoefficients( SA_NAME + '/' +( new Double( "0.00" ) ).doubleValue() ,
            0.00,-1.579,0.554,-0.560,-0.00302,0.326,6.0,0.75,0.73  );
        // SA/0.025
        DahleEtAl_AttenRelCoefficients coeff1 = new DahleEtAl_AttenRelCoefficients( "SA/" +( new Double( "0.025" ) ).doubleValue() ,
            0.025,-7.106,0.554,-0.560,-0.00302,0.326,6.0,0.75,0.73  );
        // SA/0.05
        DahleEtAl_AttenRelCoefficients coeff2 = new DahleEtAl_AttenRelCoefficients( "SA/" +( new Double( "0.05" ) ).doubleValue() ,
            0.05,-5.375,0.449,-0.575,-0.00246,0.308,6.0,0.78,0.76  );
        // SA/0.1
        DahleEtAl_AttenRelCoefficients coeff3 = new DahleEtAl_AttenRelCoefficients( "SA/" +( new Double( "0.1" ) ).doubleValue() ,
            0.1,-4.608,0.486,-0.609,-0.00198,0.381,6.0,0.81,0.79  );
        // SA/0.2
        DahleEtAl_AttenRelCoefficients coeff4 = new DahleEtAl_AttenRelCoefficients( "SA/" +( new Double( "0.2" ) ).doubleValue() ,
            0.2,-4.746,0.645,-0.674,-0.00155,0.470,6.0,0.82,0.80  );
        // SA/0.5
        DahleEtAl_AttenRelCoefficients coeff5 = new DahleEtAl_AttenRelCoefficients( "SA/" +( new Double( "0.5" ) ).doubleValue() ,
            0.5,-5.717,0.920,-0.761,-0.00106,0.566,6.0,0.83,0.81  );
        // SA/1.0
        DahleEtAl_AttenRelCoefficients coeff6 = new DahleEtAl_AttenRelCoefficients( "SA/" +( new Double( "1.0" ) ).doubleValue() ,
            1.0,-6.595,1.084,-0.792,-0.00075,0.588,6.0,0.82,0.79  );
        // SA/2.0
        DahleEtAl_AttenRelCoefficients coeff7 = new DahleEtAl_AttenRelCoefficients( "SA/" +( new Double( "2.0" ) ).doubleValue() ,
            2.0,-7.205,1.131,-0.762,-0.00051,0.536,6.0,0.79,0.75  );
        // SA/4.0
        DahleEtAl_AttenRelCoefficients coeff8 = new DahleEtAl_AttenRelCoefficients( "SA/" +( new Double( "4.0" ) ).doubleValue() ,
    ...
    class DahleEtAl_AttenRelCoefficients
         ...
         */
        public DahleEtAl_AttenRelCoefficients( String name ) { this.name = name; }
