...
public class Field_2000_IMR
     ...
     */
    private Field_2000_IMRCoefficients coeff = null;
    ...
    protected void updateCoefficients() throws ParameterException {
        ...
        if( coefficients.containsKey( key.toString() ) ) coeff = ( Field_2000_IMRCoefficients )coefficients.get( key.toString() );
    ...
    protected void initSupportedIntensityMeasureParams( ) {
        ...
        while ( keys.hasMoreElements() ) {
            Field_2000_IMRCoefficients coeff = ( Field_2000_IMRCoefficients ) coefficients.get( keys.nextElement() );
    ...
    protected void initCoefficients(  ) {
        ...
        // PGA
        Field_2000_IMRCoefficients coeff = new Field_2000_IMRCoefficients(PGA_NAME,
              0.0, 0.853, 0.872, 0.442, -0.067, -0.960, -0.154, 8.90, 0.067, -0.14, -0.1, 0.87, 0.23 );

        // SA/0.00
        Field_2000_IMRCoefficients coeff0 = new Field_2000_IMRCoefficients( SA_NAME + '/' +( new Double( "0.0" ) ).doubleValue() ,
              0.0, 0.853, 0.872, 0.442, -0.067, -0.960, -0.154, 8.90, 0.067, -0.14, -0.1, 0.87, 0.23 );
        // SA/0.3
        Field_2000_IMRCoefficients coeff1 = new Field_2000_IMRCoefficients( "SA/" +( new Double( "0.3" ) ).doubleValue() ,
              0.3, 0.995, 1.096, 0.501, -0.112, -0.841, -0.350, 7.20, 0.057, -0.12, -0.11, 0.99, 0.26 );
        // SA/1.0
        Field_2000_IMRCoefficients coeff2 = new Field_2000_IMRCoefficients( "SA/" +( new Double( "1.0" ) ).doubleValue() ,
              1.0, -0.164, -0.267, 0.903, 0.0, -0.914, -0.704, 6.20, 0.12, -0.25, -0.1, 0.95, 0.22 );
        // SA/3.0
        Field_2000_IMRCoefficients coeff3 = new Field_2000_IMRCoefficients( "SA/" +( new Double( "3.0" ) ).doubleValue() ,
    ...
    class Field_2000_IMRCoefficients
             implements NamedObjectAPI {


        protected final static String C = "Field_2000_IMRCoefficients";
        ...
        /**
         *  Constructor for the Field_2000_IMRCoefficients object
         *
         * @param  name  Description of the Parameter
         */
        public Field_2000_IMRCoefficients( String name ) { this.name = name; }

        /**
         *  Constructor for the Field_2000_IMRCoefficients object that sets all values at once
         *
         * @param  name  Description of the Parameter
         */
        public Field_2000_IMRCoefficients( String name,  double period,
        ...
        /**
         *  Gets the name attribute of the Field_2000_IMRCoefficients object
         *
