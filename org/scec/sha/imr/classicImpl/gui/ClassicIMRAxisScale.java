...
public class ClassicIMRAxisScale extends JFrame {
  ...
  private ClassicIMRTesterApp imrTesterApplet;


  public ClassicIMRAxisScale(ClassicIMRTesterApp imrTestApplet,double minX,double maxX,double minY,double maxY) {
