...
public class Point2Vert_SS_FaultPoisSource2 extends ProbEqkSource implements java.io.Serializable{
...
//  ArrayList mags, rates, rupSurfaces;
 ...
 /**
   ...
   */
  public Point2Vert_SS_FaultPoisSource2(Location loc, IncrementalMagFreqDist magFreqDist,
...
//     if(D) System.out.println(C+" random strike = "+strike);
  ...
  public ProbEqkRupture getRupture(int nthRupture){
    ...
    if(mag <= this.magCutOff)
      ...
      if(nthRupture == magFreqDist.getNum()) {
...
//                                       wc_rel,45, 1.0, 6.0, 5.0);
    Point2Vert_SS_FaultPoisSource2 src = new Point2Vert_SS_FaultPoisSource2(loc, dist,
