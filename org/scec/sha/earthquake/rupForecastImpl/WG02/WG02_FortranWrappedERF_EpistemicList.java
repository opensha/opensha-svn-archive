...
public class WG02_FortranWrappedERF_EpistemicList extends ERF_EpistemicList{
  ...
  public final static String INPUT_FILE_NAME = "WG02_WRAPPER_INPUT.DAT"; // the WG02-code output file that we read
  ...
  // configures the WG02 Fortran code input file and runs the code
   private void runFortranCode(String dirName){
     ...
     try {
       ...
       bw.write("mv "+INPUT_FILE_NAME+" "+WG02_CODE_PATH+dirName+"/.");
       bw.close();
   ...
   public void updateForecast() {
     ...
     if(parameterChangeFlag) {
       ...
       try{
         ...
         try{ inputFileLines = FileUtils.loadFile( WG02_CODE_PATH+newDir+"/"+INPUT_FILE_NAME ); }
