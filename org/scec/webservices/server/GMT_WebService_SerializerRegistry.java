...
public class GMT_WebService_SerializerRegistry implements SerializerConstants {
    ...
    public TypeMappingRegistry getRegistry() {
        ...
        }
        {
            ...
            CombinedSerializer serializer = new org.scec.webservices.GMT_WebServiceAPI_runGMT_Script_RequestStruct_SOAPSerializer(type,
            ...
            registerSerializer(mapping,org.scec.webservices.GMT_WebServiceAPI_runGMT_Script_RequestStruct.class, type, serializer);
        }
        {
            QName type = new QName("http://gravity.usc.edu/gmt/ws/GMT_WS", "runGMT_ScriptResponse");
            CombinedSerializer serializer = new org.scec.webservices.GMT_WebServiceAPI_runGMT_Script_ResponseStruct_SOAPSerializer(type,
                DONT_ENCODE_TYPE, NULLABLE, SOAPConstants.NS_SOAP_ENCODING);
            serializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF, serializer, SOAPVersion.SOAP_11);
            registerSerializer(mapping,org.scec.webservices.GMT_WebServiceAPI_runGMT_Script_ResponseStruct.class, type, serializer);
        }
        {
