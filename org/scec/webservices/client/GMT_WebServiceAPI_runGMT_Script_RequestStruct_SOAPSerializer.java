...
public class GMT_WebServiceAPI_runGMT_Script_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        org.scec.webservices.client.GMT_WebServiceAPI_runGMT_Script_RequestStruct instance = new org.scec.webservices.client.GMT_WebServiceAPI_runGMT_Script_RequestStruct();
        org.scec.webservices.client.GMT_WebServiceAPI_runGMT_Script_RequestStruct_SOAPBuilder builder = null;
        Object member;
        ...
        for (int i=0; i<2; i++) {
            ...
            if (elementName.equals(ns1_arrayOfString_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new org.scec.webservices.client.GMT_WebServiceAPI_runGMT_Script_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeInstance(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        org.scec.webservices.client.GMT_WebServiceAPI_runGMT_Script_RequestStruct instance = (org.scec.webservices.client.GMT_WebServiceAPI_runGMT_Script_RequestStruct)obj;
