...
public class GMT_WebService_Impl extends com.sun.xml.rpc.client.BasicService implements GMT_WebService {
    ...
    private static final Class GMT_WebServiceAPI_PortClass = org.scec.webservices.client.GMT_WebServiceAPI.class;
    
    public GMT_WebService_Impl() {
        super(serviceName, new QName[] {
                        ns1_GMT_WebServiceAPIPort_QNAME
                    },
            new org.scec.webservices.client.GMT_WebService_SerializerRegistry().getRegistry());
    ...
    public org.scec.webservices.client.GMT_WebServiceAPI getGMT_WebServiceAPIPort() {
        ...
        org.scec.webservices.client.GMT_WebServiceAPI_Stub stub = new org.scec.webservices.client.GMT_WebServiceAPI_Stub(handlerChain);
        try {
