...
public class GMT_WebServiceAPI_Tie
    ...
    public GMT_WebServiceAPI_Tie() throws Exception {
        super(new org.scec.webservices.server.GMT_WebService_SerializerRegistry().getRegistry());
    ...
    private void invoke_runGMT_Script(StreamingHandlerState state) throws Exception {
        ...
        org.scec.webservices.GMT_WebServiceAPI_runGMT_Script_RequestStruct myGMT_WebServiceAPI_runGMT_Script_RequestStruct = null;
        ...
        if (myGMT_WebServiceAPI_runGMT_Script_RequestStructObj instanceof SOAPDeserializationState) {
            myGMT_WebServiceAPI_runGMT_Script_RequestStruct = (org.scec.webservices.GMT_WebServiceAPI_runGMT_Script_RequestStruct)((SOAPDeserializationState)myGMT_WebServiceAPI_runGMT_Script_RequestStructObj).getInstance();
        } else {
            myGMT_WebServiceAPI_runGMT_Script_RequestStruct = (org.scec.webservices.GMT_WebServiceAPI_runGMT_Script_RequestStruct)myGMT_WebServiceAPI_runGMT_Script_RequestStructObj;
        }
        
        try {
            java.lang.String result = 
                ((org.scec.webservices.GMT_WebServiceAPI) getTarget()).runGMT_Script(myGMT_WebServiceAPI_runGMT_Script_RequestStruct.getArrayOfString_1(), myGMT_WebServiceAPI_runGMT_Script_RequestStruct.getArrayOfDataHandler_2());
            org.scec.webservices.GMT_WebServiceAPI_runGMT_Script_ResponseStruct myGMT_WebServiceAPI_runGMT_Script_ResponseStruct =
                new org.scec.webservices.GMT_WebServiceAPI_runGMT_Script_ResponseStruct();
            ...
            case runGMT_Script_OPCODE:
                {
                    ...
                    theMethod = (org.scec.webservices.GMT_WebServiceAPI.class).getMethod("runGMT_Script", carray);
                }
                break;
    ...
    private void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns1_myGMT_WebServiceAPI_runGMT_Script_ResponseStruct_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, org.scec.webservices.GMT_WebServiceAPI_runGMT_Script_ResponseStruct.class, ns1_runGMT_ScriptResponse_TYPE_QNAME);
        ns1_myGMT_WebServiceAPI_runGMT_Script_RequestStruct_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, org.scec.webservices.GMT_WebServiceAPI_runGMT_Script_RequestStruct.class, ns1_runGMT_Script_TYPE_QNAME);
    }
