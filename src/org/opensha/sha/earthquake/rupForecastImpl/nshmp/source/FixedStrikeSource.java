...
/**
 * This is a custom Point Source representation used for the NSHMP. It was
 * derived from the UCERF2 Point2Vert_FaultPoisSource.
 * 
 * This was initially created to provide built in approximations of distance
 * and hanging wall effects as well as to override getMinDistance to provide
...
public class FixedStrikeSource extends ProbEqkSource {

  private static String name = "NSHMP Point Source";
...
//  ArrayList mags, rates, rupSurfaces;
 ...
 /**
   * The Full Constructor
   	 * @param mlr magnitude length relationship used when building finite
	 *        ruptures
   ...
   * @param fracReverse - 
   */
  public FixedStrikeSource(Location loc, 
...
//    }
  ...
  /**
    ...
    */
   public FixedStrikeSource(Location loc, IncrementalMagFreqDist magFreqDist,
                                        MagLengthRelationship magLengthRelationship,
...
//    		}
  ...
  */
  ...
  public  double getMinDistance(Site site) {
	   return LocationUtils.horzDistanceFast(site.getLocation(),ptSurface.getLocation());
    }
...
//    PointSource src = new PointSource(loc, dist, wc_rel, duration, 6.0,fracStrikeSlip,fracNormal,fracReverse, false);
//
