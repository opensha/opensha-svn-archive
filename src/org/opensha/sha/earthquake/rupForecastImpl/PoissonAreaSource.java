 ...
 * <p>Description: This PrbEqkRupture class creates a set of rutures representing the seismicity 
 * generated by an area source. The option provided to generate the seismicity by taking into 
 * account the finiteness of the ruptures are the same provided in the <code>PointToLineSource</code>
 * class, plus the option to treat all sources as point sources is also included here. </p>
 * 
