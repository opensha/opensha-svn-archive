...
public class NewFloatingPoissonFaultSource extends ProbEqkSource {
  ...
  protected String  NAME = "New Floating Poisson Fault Source";
   ...
   */
  public NewFloatingPoissonFaultSource(IncrementalMagFreqDist magDist,
