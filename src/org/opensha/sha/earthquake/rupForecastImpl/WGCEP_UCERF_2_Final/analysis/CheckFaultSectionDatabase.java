...
public class CheckFaultSectionDatabase {
	public static void main(String args[]) {
		...
		defModels.add("D2.5");
		defModels.add("D2.6");
		DeformationModelSummaryDB_DAO defModelSummaryDAO = new DeformationModelSummaryDB_DAO(DB_AccessAPI.db_ver2_ro_conn);
		DeformationModelPrefDataDB_DAO defModelPrefDAO = new DeformationModelPrefDataDB_DAO(DB_AccessAPI.db_ver2_ro_conn);
