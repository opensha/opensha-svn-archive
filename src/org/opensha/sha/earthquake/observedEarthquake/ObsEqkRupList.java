...
public class ObsEqkRupList implements java.io.Serializable{
	...
	private ArrayList<ObsEqkRupture> obsEqkList = new ArrayList<ObsEqkRupture>();
	 ...
	 */
	public ArrayList<ObsEqkRupture> getObsEqkRupEventList() {
		return obsEqkList;
	}
	 ...
	 *
	 */
	public ListIterator<ObsEqkRupture> listIterator() {
	...
	public int compareTo(Object obj) {
		...
		ListIterator<ObsEqkRupture> it = obsEventList.listIterator();
		ListIterator<ObsEqkRupture> it1 = listIterator();

		if (size() != obsEventList.size())
			return -1;

		while (it.hasNext()) {
			ObsEqkRupture event1 = it.next();
			ObsEqkRupture event2 = it1.next();
