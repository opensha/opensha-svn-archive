 ...
 * 
 * This calss tests both Atkinson & Boore and Johnson mblg to Mw magnitude
 * conversion branches.
 * 
 * @author Peter Powers
 * 
...
public class CEUS_IMR_Tests {
	...
	private static final String RESULTS_BASE = SystemUtils.USER_DIR +
		"/test/org/opensha/sha/imr/attenRelImpl" +
		"/test/AttenRelResultSetFiles/nshmp/";

	// AB mag conversion; firm-rock
	private static String ceus_ab_bc_name = RESULTS_BASE + "CEUS_AB_BC.txt";
	private static File ceus_ab_bc = new File(ceus_ab_bc_name);
	private static String ceus_j_bc_name = RESULTS_BASE + "CEUS_J_BC.txt";
