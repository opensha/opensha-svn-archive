 ...
 * by Frankel et al. (1996). This implementation matches that used in the USGS
 * NSHMP.<br />
 * <br />
...
public class FrankelEtAl_1996_AttenRel extends AttenuationRelationship implements
	...
	private double getMean(int iper, SiteType st, double rRup, double mag) {
		GM_Table table = (st == HARD_ROCK) ? gmTablesHard.get(iper) : gmTablesSoft.get(iper);
...
//	void getFEA(int ip, int iq, int ir, int ia, int ndist, double di, int nmag,
...
//		// k006
//		double[] bsigma = { 0.326, 0.326, 0.347, 0.326, 0.326, 0.326, 0.347, 0.326, 0.326 };
//		double[] clamp = { 3.0, 6.0, 0.0, 6.0, 6.0, 6.0, 0.0, 6.0, 6.0 };
//		String[] srTables = { "pgak01l.tbl", "t0p2k01l.tbl", "t1p0k01l.tbl", "t0p1k01l.tbl", "t0p3k01l.tbl", "t0p5k01l.tbl", "t2p0k01l.tbl" };
//		String[] hrTables = { "pgak006.tbl ", "t0p2k006.tbl", "t1p0k006.tbl", "t0p1k006.tbl", "t0p3k006.tbl", "t0p5k006.tbl", "t2p0k006.tbl", "tp04k006.tbl", "t0p4k006.tbl" };
...
//			System.out.println(gmt.get(5.1, Math.pow(10,1.55)) / Utils.LOG_BASE_10_TO_E);
//			System.out.println(gmt.get(7.1, Math.pow(10,1.55)) / Utils.LOG_BASE_10_TO_E);
//			System.out.println(gmt.get(5.1, Math.pow(10,2.55)) / Utils.LOG_BASE_10_TO_E);
//			System.out.println(gmt.get(7.1, Math.pow(10,2.55)) / Utils.LOG_BASE_10_TO_E);
//		} catch (IOException ioe) {
//			ioe.printStackTrace();
//		}
//		
