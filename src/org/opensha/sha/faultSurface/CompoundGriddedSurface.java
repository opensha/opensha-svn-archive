...
public class CompoundGriddedSurface implements RuptureSurface {
	...
	ArrayList<AbstractEvenlyGriddedSurface> surfaces;
	...
	public CompoundGriddedSurface(ArrayList<AbstractEvenlyGriddedSurface> surfaces) {
	...
	private void computeInitialStuff() {
		...
		AbstractEvenlyGriddedSurface surf1 = surfaces.get(0);
		AbstractEvenlyGriddedSurface surf2 = surfaces.get(1);
		...
		for(int s=0; s<surfaces.size();s++) {
			AbstractEvenlyGriddedSurface surf = surfaces.get(s);
...
//	    System.out.println(cucamonga.getFaultTrace());
	    ...
	    ArrayList<AbstractEvenlyGriddedSurface> surfList = new ArrayList<AbstractEvenlyGriddedSurface>();
