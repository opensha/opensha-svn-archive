 ...
 * @version 1.0
 */
public class DisaggregationRuptureComparator implements Comparator, java.io.Serializable {
  ...
  public int compare(Object object1, Object object2) {
    ...
    if(sourceInfo1.getEventRate() > sourceInfo2.getEventRate())
      return -1;
    else if(sourceInfo1.getEventRate() == sourceInfo2.getEventRate())
      return 0;
    else
      return 1;
  }
