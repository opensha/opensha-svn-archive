...
public class SectionIDIden extends AbstractRuptureIdentifier {
	...
	public static SectionIDIden getNSAF(List<RectangularElement> elems) {
		// NOTE: no creeping
	...
	public static SectionIDIden getSSAF(List<RectangularElement> elems) {
...
//				"SAF-Coachella", "SAF-Mojave", "SAF-San_Bernar"));
	...
	public static SectionIDIden getSanJacinto(List<RectangularElement> elems) {
		return new SectionIDIden("San Jacinto", elems, parseNames(elems, "Anza", "San_Bernardino", "San_Jacinto"));
	}
	
	public static SectionIDIden getElsinore(List<RectangularElement> elems) {
		return new SectionIDIden("Elsinore", elems, parseNames(elems, "Coyote_Mt.", "Glen_Ivy", "Julian", "Temecula" ,"Whittier"));
	}
	
	public SectionIDIden(String name, List<RectangularElement> elems, int sectionID) {
		this(name, elems, Lists.newArrayList(sectionID));
	}
	
	public SectionIDIden(String name, List<RectangularElement> elems, int... sectionIDs) {
		this(name, elems, Ints.asList(sectionIDs));
	}
	
	public SectionIDIden(String name, List<RectangularElement> elems, List<Integer> sectionIDs) {
		this.name = name;
		elementIDs = new HashSet<Integer>(getElemIDs(elems, sectionIDs));
	}
	
	private static List<Integer> getElemIDs(List<RectangularElement> elems, List<Integer> sectionIDs) {
	...
	public static List<Integer> parseNames(List<RectangularElement> elems, String... sectionNames) {
		return parseNames(elems, Lists.newArrayList(sectionNames));
	}
	
	public static List<Integer> parseNames(List<RectangularElement> elems, List<String> sectionNames) {
