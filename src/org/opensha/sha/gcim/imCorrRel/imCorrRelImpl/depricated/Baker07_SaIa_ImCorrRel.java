...
/**
 * <b>Title:</b>Baker07_SaIa_ImCorrRel<br>
 *
 * <b>Description:</b>  This implements the Baker correlation
 * relationship between Ia and spectral acceleration at period Ti 
 * 
...
public class Baker07_SaIa_ImCorrRel extends ImCorrelationRelationship {

    final static String C = "Baker07_SaIa_ImCorrRel";
    public final static String NAME = "Baker (2007) SA,IA";
    ...
    /**
     * Computes the correlation coefficient between Ia and Sa at period Ti.
     * @param ti, spectral period in seconds
     * @return pearson correlation coefficient between lnIa and lnSa(Ti)
     */
    public double getImCorrelation(){
    	if ((imi.getName()==SA_InterpolatedParam.NAME&&imj.getName()==IA_Param.NAME)||
    		...
    		return Double.NaN;  //TODO should make this an error??
    	}
    ...
    /**
     *  Creates the supported IM parameters (SA and IA), as well as the
     *  independenParameters of SA (periodParam and dampingParam) and adds
     *  them to the supportedIMParams list. Makes the parameters noneditable.
     */
    protected void initSupportedIntensityMeasureParams() {
    	  
      // Create saInterpParam:
...
//      supportedIMiParams.addParameter(saInterpParam);		supportedIMjParams.addParameter(iaParam);
//      supportedIMiParams.addParameter(iaParam);				supportedIMjParams.addParameter(saInterpParam);
