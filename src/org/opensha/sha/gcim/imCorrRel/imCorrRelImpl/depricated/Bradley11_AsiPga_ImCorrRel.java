...
/**
 * <b>Title:</b>Bradley11_AsiPga_ImCorrRel<br>
 *
 * <b>Description:</b>  This implements the Bradley 2011 correlation
 * relationship between ASI and PGA 
 * 
...
public class Bradley11_AsiPga_ImCorrRel extends ImCorrelationRelationship {

    final static String C = "Bradley11_AsiPga_ImCorrRel";
    public final static String NAME = "Bradley (2011) ASI,PGA";
     ...
     */
    public Bradley11_AsiPga_ImCorrRel() {
    ...
    /**
     * Computes the correlation coefficient between ASI and PGA
     * @return pearson correlation coefficient between lnASI and lnPGA
     */
    public double getImCorrelation(){
    	if ((imi.getName()==ASI_Param.NAME&&imj.getName()==PGA_Param.NAME)||
        		(imi.getName()==PGA_Param.NAME&&imj.getName()==ASI_Param.NAME)) {
    		
    		return 0.906;
        	//The standard deviation in the transformed z value of 0.065 is not presently considered
...
//	  supportedIMiParams.addParameter(asiParam);		supportedIMjParams.addParameter(pgaParam);
//	  supportedIMiParams.addParameter(pgaParam);		supportedIMjParams.addParameter(asiParam);
