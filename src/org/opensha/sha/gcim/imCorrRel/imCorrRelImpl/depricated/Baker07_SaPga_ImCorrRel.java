 ...
 * relationship between PGA and spectral acceleration at period Ti 
 * 
...
public class Baker07_SaPga_ImCorrRel extends ImCorrelationRelationship {

    final static String C = "Baker07_SaPga_ImCorrRel";
    public final static String NAME = "Baker (2007) SA,PGA";
     ...
     * (as the default)
     */
    public Baker07_SaPga_ImCorrRel() {
