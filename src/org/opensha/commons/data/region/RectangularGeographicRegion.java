...
//			return true;
	...
	/**
	 * Returns true if the given RectangularGeographicRegion is fully contained within this
	 * RectangularGeographicRegion. It will still return true if any of the edges are equal.
	 * 
	 * @param region
	 * @return
	 */
