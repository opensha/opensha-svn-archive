...
public class CVM4BasinDepth extends AbstractSiteData<Double> {
	...
	public static final String SERVLET_2_5_URL = Preferences.OPENSHA_SERVLET_URL + "SiteData/CVM4_2_5";
	public static final String SERVLET_1_0_URL = Preferences.OPENSHA_SERVLET_URL + "SiteData/CVM4_1_0";
