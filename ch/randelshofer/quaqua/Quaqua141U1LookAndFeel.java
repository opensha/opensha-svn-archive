/*
 * @(#)Quaqua141U1LookAndFeel.java  1.2.1  2003-10-29
 *
...
/**
 * The Quaqua141U1LookAndFeel provides quick (and dirty) bug fix for the Aqua
 * Look and Feel which is part of Apple's implementation of the
 * Java 2 Runtime Environment, Standard Edition 1.4.1 Update 1.
 * <p>
 ...
 * <br><b>XXX</b> This fix breaks Tabbed panes with tabs located to the left or to the
 ...
 * @version 1.2.1 2003-10-29 Renamed QuaquaSeparatorUI to Quaqua141U1SeparatorUI.
 * <br>1.2 2003-10-05 JFileChooser with column view added. MenuItem fix
 * for accelerator key symbols is active now. Missing get...Font() methods added.
 * Menu related workarounds work only if useScreenMenuBar is switched off.
 * <br>1.0 2003-09-11 Created.
 */
public class Quaqua141U1LookAndFeel extends LookAndFeelProxy {
    /**
    ...
    protected void initClassDefaults(UIDefaults table) {
        ...
        String quaqua141U1Prefix = "ch.randelshofer.quaqua.Quaqua141U1";
      ...
      /*
             ...
             "ToggleButtonUI", basicPrefix + "ToggleButtonUI",*/
              //  "PopupMenuUI", basicPrefix + "PopupMenuUI",
                "SeparatorUI", quaqua141U1Prefix + "SeparatorUI",
       ...
       "PopupMenuSeparatorUI", quaqua141U1Prefix + "SeparatorUI",
