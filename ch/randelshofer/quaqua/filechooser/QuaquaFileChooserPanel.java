/*
 * @(#)TestQuaquaFileChooserPanel.java  1.0  July 24, 2003
 *
 ...
 * @version 1.0 July 24, 2003  Created.
 */
public class QuaquaFileChooserPanel extends javax.swing.JPanel {
    
    /** Creates a new instance. */
    public QuaquaFileChooserPanel() {
        initComponents();
    }
    
    public static void main(String[] args) {
        JFrame f = new JFrame("Open Dialog");
        f.getContentPane().add(new QuaquaFileChooserPanel());
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new java.awt.Insets(0, 6, 14, 24);
