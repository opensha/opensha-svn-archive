...
public class BirthdayDistribution extends Distribution {
    ...
    /**
     *  This method sets the parameters: the population size and the sample
     *  size. Also, the probabilities are computed and stored in an array
     *
     ...
     *
     * @param  k  The new sampleSize value
     */
