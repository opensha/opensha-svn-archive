...
public class DataFileNameSelectorForHazardCurves {
   ...
   * @return String
   */
  private String getFileNameForAlaska(String selectedEdition,String selectedHazardCurveType){
  ...
  private String getFileNameForPRVI(String selectedEdition,String selectedHazardCurveType){
    if (selectedHazardCurveType.equals(GlobalConstants.PGA)) {
   ...
   * @return String
   */
  private String getFileNameForHawaii(String selectedEdition, String selectedHazardCurveType){
    if (selectedHazardCurveType.equals(GlobalConstants.PGA)) {
  ...
  private String getFileNameFor48States(String selectedEdition, double lat,
                             double lon,String selectedHazardCurveType) {
    if (selectedEdition.equals(GlobalConstants.data_1996)) {
      if (lon >= -125 && lon <= -111 && lat >= 32 && lat <= 43) { //getting the file for CA and NV
        ...
        else if(selectedHazardCurveType.equals(GlobalConstants.IMT_POINT_FIVE_SEC)){
