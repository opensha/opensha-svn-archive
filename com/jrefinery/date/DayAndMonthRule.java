...
public class DayAndMonthRule extends AnnualDateRule implements Cloneable {
     ...
     * <P>
     * For the month parameter, use SerialDate.JANUARY, etc. Note that there are no checks to
     * prevent you from entering an invalid combination (such as 31 February).
    ...
    public void setDayOfMonth(int dayOfMonth) {
        ...
        if ((dayOfMonth<1) || (dayOfMonth>SerialDate.LAST_DAY_OF_MONTH[month])) {
            throw new IllegalArgumentException("DayAndMonthRule(...): "
                                               +"dayOfMonth outside valid range.");
        }
     ...
     * <P>
     * The codes JANUARY, FEBRUARY, MARCH, APRIL, MAY, JUNE, JULY, AUGUST, SEPTEMBER, OCTOBER,
     * NOVEMBER and DECEMBER are defined in the SerialDate class.
