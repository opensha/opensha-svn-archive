...
/**
 * An annual date rule that specifies the nth day of the week in a given month (e.g. the third
 * Wednesday in June, or the last Friday in November).
 */
    ...
    public SerialDate getDate(int year) {
        ...
        if (count!=SerialDate.LAST_WEEK_IN_MONTH) {
            ...
            while (result.getDayOfWeek()!=dayOfWeek) {
                result = result.addDays(1, result);
            }
            result = result.addDays(7*(count-1), result);
