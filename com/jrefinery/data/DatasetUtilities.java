...
public class DatasetUtilities {
    ...
    /**
     * Constructs an array of arrays of Number objects from a corresponding structure containing
     * double primitives.
     *
     * @param data The data.
     */
    ...
    /**
     * Returns the range of values in the range for the dataset.  This method is the partner for
     * the getDomainExtent method.
     *
     * @param data The dataset.
     */
    public static Range getRangeExtent(Dataset data) {
        ...
        // check parameters...
        if (data==null) {
            throw new IllegalArgumentException("Datasets.getMinimumRangeValue: "
                                               +"null dataset not allowed.");
        }
     ...
     * <P>
     * This is easy if the dataset implements the DomainInfo interface (a good idea if there is an
     * efficient way to determine the minimum value).  Otherwise, it involves iterating over the
     * entire data-set.
     *
     * @return The minimum domain value in the dataset (or null if all the values in the dataset
     *         are null).
     */
     ...
     * <P>
     * This is easy if the dataset implements the DomainInfo interface (a good idea if there is an
     * efficient way to determine the maximum value).  Otherwise, it involves iterating over the
     * entire data-set.
     *
     * @return The maximum domain value in the dataset (or null if all the values in the dataset
     *         are null).
     */
     ...
     * <P>
     * This is easy if the dataset implements the RangeInfo interface (a good idea if there is an
     * efficient way to determine the minimum value).  Otherwise, it involves iterating over the
     * entire data-set.
     *
     * @return The minimum range value in the dataset (or null if all the values in the dataset
     *         are null).
     */
     ...
     * entire data-set.
     *
     * @return The maximum range value in the dataset (or null if all the values in the dataset
     *         are null).
     */
    ...
    /**
     * Creates a pie dataset from a category dataset by taking all the values (across series) for
     * a single category.
     *
     * @param data The data.
    ...
    /**
     * Returns the range of values for the range (as in domain/range) of the dataset, assuming that
     * the series in one category are stacked.
     *
     * @param data The dataset.
     */
            ...
            while (iterator.hasNext()) {
                ...
                for (int series=0; series<seriesCount; series++) {
                    ...
                    if (number!=null) {
                        ...
                        if (value>0.0) positive = positive + value;  // remember value is negative
                        if (value<0.0) negative = negative + value;  // remember value is negative
                    }
                }
        ...
        if (data!=null) {
            ...
            while (iterator.hasNext()) {
                ...
                for (int series=0; series<seriesCount; series++) {
                    ...
                    if (number!=null) {
                        double value = number.doubleValue();
                        if (value<0.0) total = total + value;  // remember value is negative
                    }
                }
