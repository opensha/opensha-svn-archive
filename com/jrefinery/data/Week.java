...
//    private static long MILLISECONDS_PER_WEEK = 7 * 24 * 60 * 60 * 1000;
    ...
    /**
     * Tests the equality of this Week object to an arbitrary object.  Returns true if the
     * target is a Week instance representing the same week as this object.  In all other
     * cases, returns false.
    ...
    /**
     * Returns an integer indicating the order of this Week object relative to the specified
     ...
     * <P>
     * This method is required to accept the format "YYYY-Wnn".  It will also accept "Wnn-YYYY".
        ...
        if (s!=null) {
            ...
            if (i!=-1) {
                ...
                if (year!=null) {
                    ...
                    if (week==-1) {
                        throw new TimePeriodFormatException("Week.parseWeek(String): can't "
                                                            +"evaluate the week.");
                    }
                ...
                throw new TimePeriodFormatException("Week.parseWeek(String): could not find "
                                                    +"separator.");
            }
    ...
    public static void main(String[] args) {
        Week w = Week.parseWeek("W09-2000");
    }
