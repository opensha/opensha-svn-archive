...
public class GenericRJ_Parameters implements Serializable {
	

	/**
	 * 
	 */
	private static final long serialVersionUID = 3741256518973904235L;
	...
	/**
	 * This one should return generic global parameters or something.
	 */
	public GenericRJ_Parameters(){
		this.aValue_mean = Double.NaN;
		this.aValue_sigma = Double.NaN;;	// magnitude independent sigma
		this.aValue_sigma0 = Double.NaN;;	// param for mag-depednen
		this.aValue_sigma1 = Double.NaN;;
		this.bValue = Double.NaN;;
		this.pValue = Double.NaN;;
		this.cValue = Double.NaN;;
	}
