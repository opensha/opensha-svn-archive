...
public class HardCodedExample {
	...
	public static void main(String[] args) {
		...
		ArbDiscrEmpiricalDistFunc M5distFunc = genericModel.computeNumMag5_DistributionFunc(dataMaxDays+forecastMinDays, dataMaxDays+forecastMaxDays);
		System.out.println(M5distFunc);
		System.out.println(M5distFunc.getSumOfAllY_Values());
