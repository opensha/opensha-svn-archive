...
public class CreateRupturesFromSections {
	...
	public CreateRupturesFromSections(double maxJumpDist, double maxSubSectionLength, int minNumSubSectInRup) {
		...
		// to do: save to a file to save time
...
/*	*/	  
		  ...
		  test = "_test";
		  ArrayList<UCERF2_FaultSectionPrefData> trimmedFaultSectionPrefData = new ArrayList<UCERF2_FaultSectionPrefData>();
		  ...
		  //trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(38));
		  ...
		  // Bay Area Faults
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(131));	
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(130));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(133));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(120));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(63));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(64));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(8));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(7));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(9));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(57));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(58));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(18));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(140));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(141));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(59));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(60));
		  trimmedFaultSectionPrefData.add(allFaultSectionPrefData.get(95));
