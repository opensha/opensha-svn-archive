 ...
 * @version $Id:$
 */
public class Idriss_2013_Transitional implements TransitionalGMPE {

	private Idriss_2013 impl = new Idriss_2013();
...
//		System.out.println(Joiner.on('\t').join(Mw, rRup, vs30, style));
	...
	@Override public String getName() { return Idriss_2013.NAME; }
