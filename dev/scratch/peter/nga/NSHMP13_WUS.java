...
//		setParamDefaults();
	...
	void initGMPEmap() {
		...
		gmpeMap.put(new CB_2013_Transitional(), 0.22);
		gmpeMap.put(new CY_2013_Transitional(), 0.22);
		gmpeMap.put(new ASK_2013_Transitional(), 0.22);
		gmpeMap.put(new BSSA_2013_Transitional(), 0.22);
		gmpeMap.put(new Idriss_2013_Transitional(), 0.12);
//		gmpeMap.put(new GK_2013_Transitional(), 0.0);
	}
