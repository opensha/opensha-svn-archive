 ...
 *
 */
public class OldSectionCluster extends ArrayList<Integer> {
	
	protected final static boolean D = true;  // for debugging
	
	ArrayList<UCERF2_FaultSectionPrefData> sectionDataList;
	 ...
	 * @param maxRakeDiff
	 */
	public OldSectionCluster(ArrayList<UCERF2_FaultSectionPrefData> sectionDataList, int minNumSectInRup, 
