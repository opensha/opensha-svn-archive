...
//		double maxX = minX + gridSpacing * (ncols-1);
	...
	public void testAddValue() {
		...
		assertEquals("addValue didn't work", 0.35, data.get(minX, minY), 0.0000001);
		assertEquals("addValue didn't work", 0.35, data.get(0, 0), 0.0000001);
		...
		assertEquals("addValue didn't work", 0.35, data.get(minX + gridSpacing, minY + gridSpacing), 0.0000001);
		assertEquals("addValue didn't work", 0.35, data.get(1, 1), 0.0000001);
	}
