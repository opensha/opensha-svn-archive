...
public class GMT_WebServiceAPI_runGMT_Script_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        unusedArchive.webservices.GMT_WebServiceAPI_runGMT_Script_ResponseStruct instance = new unusedArchive.webservices.GMT_WebServiceAPI_runGMT_Script_ResponseStruct();
        unusedArchive.webservices.GMT_WebServiceAPI_runGMT_Script_ResponseStruct_SOAPBuilder builder = null;
        Object member;
        ...
        if (reader.getState() == XMLReader.START) {
            ...
            if (member instanceof SOAPDeserializationState) {
                if (builder == null) {
                    builder = new unusedArchive.webservices.GMT_WebServiceAPI_runGMT_Script_ResponseStruct_SOAPBuilder();
                }
    ...
    public void doSerializeInstance(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        unusedArchive.webservices.GMT_WebServiceAPI_runGMT_Script_ResponseStruct instance = (unusedArchive.webservices.GMT_WebServiceAPI_runGMT_Script_ResponseStruct)obj;
